...
##### **마이페이지**:
회원은 마이페이지에서 자신의 개인 정보를 확인하고 수정할 수 있다.

##### **나만의 플레이리스트**:
회원은 자신만의 플레이리스트를 생성할 수 있다.
생성한 플레이리스트는 목록으로 조회되며, 플레이리스트의 제목을 클릭하면 플레이리스트의 상세 내용을 확인할 수 있다.
플레이리스트에는 노래를 추가, 삭제, 수정할 수 있는 기능이 있다.
...
##### **플레이리스트에 노래 소개**:
플레이리스트를 만든 회원은 각 노래에 대한 소개 내용을 짧게 작성하여 추가할 수 있다.

##### **자기 플레이리스트 소개란**:
회원은 자신의 플레이리스트를 소개하는 내용을 작성하여 공유할 수 있다.
